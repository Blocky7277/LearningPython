...
class RAYCAST:
    def __init__(self, game):
        ...
        self.unrendered_objects = []
        self.textures = self.game.object_renderer.wall_textures

    def get_unrendered_objects(self):
        self.unrendered_objects = []
        for ray, values in enumerate(self.ray_casting_result):
            ...
            self.unrendered_objects.append((depth, wall_column, wall_pos))
    ...
    def ray_cast(self):
        ...
        for ray in range(RAY_NUM):
            ...
            # horizontals
            y_hor,delta_y = (y_map + 1, 1) if sin_a > 0 else (y_map - 1e-6, -1)
            ...
            # verticals
            x_vert,delta_x = (x_map + 1, 1) if cos_a > 0 else (x_map - 1e-6, -1)
